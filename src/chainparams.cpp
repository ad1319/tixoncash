...
// Copyright (c) 2017-2018 The Tixoncash developers
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1543052277, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 30; // Tixoncash: 1 day
        nTargetSpacing = 1 * 60;  // Tixoncash: 2 minutes
        nMaturity = 10;
        ...
        nLastPOWBlock = 200;
        nModifierUpdateBlock = 1; // we use the version 2 for TXCH
        ...
        genesis.nNonce = 860312;
 
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000dfecf20a0e97ee2a6a6f9ed54121c81325ed28cb367f74a641212df1620"));
        ...
        // Tixoncash addresses start with 'G'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 38);
        // Tixoncash script addresses start with '3'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 6);
        // Tixoncash private keys start with 'K'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 46);
        // Tixoncash BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Tixoncash BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // Tixoncash BIP44 coin type is '222' (0x800000de)
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Tixoncash: 1 day
        nTargetSpacing = 2 * 60;  // Tixoncash: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        // Testnet Tixoncash addresses start with 'g'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 98);
        // Testnet Tixoncash script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet Tixoncash BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Tixoncash BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Tixoncash: 1 day
        nTargetSpacing = 2 * 60;        // Tixoncash: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1516926684;
